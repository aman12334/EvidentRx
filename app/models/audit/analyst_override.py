...
class AnalystOverride(Base):
    ...
    finding_id:     Mapped[UUID | None]= mapped_column(PGUUID(as_uuid=True), ForeignKey("audit.audit_findings.finding_id"))
    case_id:        Mapped[UUID | None]= mapped_column(PGUUID(as_uuid=True), ForeignKey("audit.investigation_cases.case_id"))
