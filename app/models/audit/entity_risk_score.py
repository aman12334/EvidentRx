...
class EntityRiskScore(Base):
    ...
    finding_velocity:       Mapped[Decimal | None] = mapped_column(Numeric(10, 4))
    exposure_trajectory:    Mapped[Decimal | None] = mapped_column(Numeric(15, 2))
    escalation_probability: Mapped[Decimal | None] = mapped_column(Numeric(5, 4))
